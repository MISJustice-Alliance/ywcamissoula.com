...
## Current status and case evolution

**Current posture:** ODC 25-147 is recorded here as denied on review and closed. No notice of the review denial was received, so the justification used by ODC is unknown. The May 2026 supplemental materials—Supplemental Submission #4, Tyrone Nuno's supporting witness grievance, and Eleanor ("Ellie") Nuno's independent grievance/supporting submission—were submitted as new material that functionally placed the Tipp matter back before ODC for reconsideration and opened or expanded the investigative record relating to Eleanor Nuno's grievance.

**Unresolved procedural status — the Supreme Court review question:** Per the complainant's own account, Elvis Nuno did in fact submit a request for Montana Supreme Court review of the ODC's disposition. ODC has referenced this in writing on at least two separate occasions — the July 10, 2026 letter and, again, the July 30, 2026 letter — but both references are opaque: each states only that "our records indicate that you did pursue such an appeal" (verbatim, verified by direct image review of both letters; see "Verbatim confirmation" below), without stating what that appeal's current status is, whether it is pending, decided, or was never docketed, or whether ODC File No. 25-147 is consequently still open in any parallel review track. ODC has not, in any letter currently in the record, disclosed a docket number, a disposition, or a status for that review. The result is that the file's closure status cannot presently be verified as final by anyone outside ODC and the Montana Supreme Court Clerk's office — a state the complainant has described as a "legal-layman's Schrödinger's cat": simultaneously closed (per ODC's own repeated "this matter remains closed" language) and still procedurally unresolved (per ODC's own acknowledgment that a Supreme Court appeal was pursued), with no public document reconciling the two. This is recorded here as an open question, not a resolved fact in either direction, pending independent verification against the Montana Supreme Court's own docket.

**Verbatim confirmation:** Both source images were reviewed directly (not re-typed from a prior transcription) on 2026-09-24. The July 10, 2026 letter states: "You were notified of your ability to appeal to the Supreme Court, who has the ultimate decision in attorney discipline, but our records indicate that you did pursue such an appeal." The July 30, 2026 letter repeats the identical sentence verbatim. Neither letter contains the word "not" in that sentence in either printing — this corrects an earlier working assumption on this site (see the [July 2026 closure response analysis](odc-25-147-july-2026-closure-response-analysis.md), now updated) that a "not" had been dropped by the photocopier and that the intended reading was the opposite.

**Update — ODC responses received (as of this record):**

* **Elvis R. Nuno:** ODC sent a **July 10, 2026** letter (see the [July 2026 closure response analysis](odc-25-147-july-2026-closure-response-analysis.md)) followed by a **July 30, 2026** letter, signed by Chief Disciplinary Counsel Pamela D. Bucy, reiterating the "strategy vs. objectives" rationale, characterizing the Supplemental Submission #4 material as "additional examples of strategy" that did "not change ODC's analysis," and asserting that Tipp "was able to provide explanation" without disclosing that explanation. Both the July 10 and the July 30 letters independently state, in identical verbatim language confirmed by direct review of both source images, that "our records indicate that you did pursue such an appeal" to the Montana Supreme Court — per the complainant's account, this is accurate (he did submit such a request), but ODC has not disclosed the request's status, docket number, or disposition in either letter or in any other document currently in the record. See "Unresolved procedural status" above and the [technicality-defense analysis](odc-file-no-25-147-july-30-2026-closure-letter-technicality-defense-analysis.md) and the [public-facing explainer](public-article-odc-25-147-what-the-ruling-means-and-why-it-warrants-review.md).
* **Eleanor ("Ellie") Nuno:** ODC responded by letter dated **August 21, 2026**. This letter has not been independently supplied to the repository; its content is known only through a family legal-analysis memorandum's description and direct quotation, and is reported here on that attributed basis only. Per the memorandum, ODC acknowledged receiving Eleanor Nuno's May 2026 grievance but stated it was placed into her son's existing file rather than opened as a separate grievance, and that "after considering the information, it did not change our analysis of this matter." The memorandum also quotes the letter restating that ODC "issued a dismissal on November 3, 2025" following "completion of our investigation of the entire grievance," and that the Commission on Practice "affirmed the decision" on January 7, 2026. Neither this letter nor the July 30 letter to Elvis identifies which specific rule provisions apply to each individual allegation or confirms whether each named exhibit (the disputed maternal statement, the P.S. email, the Stratford psychiatric letter, the officer's removal, or the DPA speech-waiver terms) was individually reviewed. Full sourcing, attribution, and a claims-to-sources table are in the [public-facing explainer article](public-article-odc-25-147-what-the-ruling-means-and-why-it-warrants-review.md).
* **Tyrone Nuno:** **As of this record, no response has been received from ODC regarding the Tyrone Nuno supporting-witness grievance.**

**Publication note:** the July 2026 clarification request regarding ODC's closure letter is published separately as a source record so readers can compare the request, the July 10 response, and the underlying Supplemental Submission #4. The July 30, 2026 closure letter to Elvis Nuno and the August 21, 2026 letter to Eleanor Nuno (as described above) are both analyzed in the technicality-defense article and the public-facing explainer, which document how ODC's "strategy" framing, its unsubstantiated "explanation" assertion, its handling of Eleanor Nuno's independent-grievance status, and its formalistic appeal language operate as an evidentiary black box that resists meaningful review.
...
* Original complaint packet: [MT Bar Complaint ODC No. 25-147 - Bryan Tipp of Tipp, Colburn, Lockwood, P.C. (July 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july)
* ODC disposition: [MT Bar Complaint ODC No. 25-147: ODC Ruling (November 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-response-to-bryan-tipp-bar-complaint-answer-octo/mt-bar-complaint-odc-no.-25-147-odc-ruling-november-2025)
* Review request: [MT Bar Complaint ODC-25-147 - Right To Request Review (November 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-25-147-right-to-request-review-november-2025)
* Current synthesis: [Tipp malpractice and Lowney ODC grievance: civil intake case analysis](https://www.ywcaofmissoula.com/montana-bar-complaints/odc-25-147-lowney-case-authorities-analysis)
* Companion prosecutorial-misconduct grievance: [Grievance to Montana ODC — Brian Lowney (April 28, 2026)](https://www.ywcaofmissoula.com/montana-bar-complaints/grievance-to-montana-odc-brian-lowney-4.28.2026)
* Companion Lowney index: [ODC Lowney Grievance (April 2026) — Montana Bar Complaint Index](https://www.ywcaofmissoula.com/montana-bar-complaints/odc-lowney-grievance-index)
* May 2026 evidence supplement: [MT Bar Complaint ODC No. 25-147: Supplemental Submission #4](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-supplemental-submission-4-may-2026)
...
This index is written for **attorneys, investigators, journalists, and oversight reviewers** who need fast access to the record.

It is also useful for **civil-rights advocates** and **technical readers** assessing digital-evidence and compelled-access issues.

### Topics covered

* Montana Office of Disciplinary Counsel (ODC)
* Montana attorney discipline and Commission on Practice review
* Bryan Tipp (Missoula, Montana)
* Legal malpractice, competence, diligence, and conflicts of interest
* Brian Lowney prosecutorial misconduct grievance and Brady/Giglio theory
* MPD investigator conflict, Officer Ethan Smith removal, and Detective Brueckner/YWCA conflict
* E'Lise Chard, YWCA of Missoula, and institutional information-sharing evidence
* First Amendment and Fifth Amendment issues in plea or resolution terms
* Digital evidence and compelled password disclosure
* Statute of limitations (SOL) and time-barred civil rights claims
...
1. Start with the original complaint.
2. Read the supplemental submissions and appendices.
3. Review the respondent response and the complainant response.
4. Read the ODC ruling, then the request for review.
5. Read the current civil-intake/case-authorities analysis for corrected attorney-malpractice classification, legal-malpractice limitations, and ODC posture.
6. Read the Brian Lowney grievance and Lowney index to understand the companion prosecutorial-misconduct track.
...
12. Read the representation-gap investigative report for an exhibit-by-exhibit comparison of the "strategy" rationale and a documented Montana attorney declination relevant to the complainant's ability to secure counsel.

### Evolution at a glance

| Stage | Filing or evidence located | What changed | Relation to broader misconduct record |
| --- | --- | --- | --- |
| July 2025 original grievance | Original ODC 25-147 complaint | Opened the Tipp malpractice record around missed civil-rights deadlines, "give it time" advice, loss of claims, and alleged failures of competence, diligence, and communication. | Focused primarily on defense-counsel malpractice and the civil-remedy consequences of the criminal representation. |
| August 2025 Supplemental #1 and appendices | Conflict analysis, missed motions, constitutional violations, and lost-claims documentation | Expanded the theory from missed civil filing deadlines into criminal-defense failures that allegedly allowed constitutional violations to go unchallenged. | Connected Tipp's omissions to MPD investigative issues, alleged YWCA institutional conflicts, and the loss of civil-rights accountability. |
| September 2025 Supplemental #3 | Device-password coercion | Added a discrete compelled-access/digital-evidence theory: Tipp allegedly pressured disclosure of device passwords despite Fifth Amendment, cybersecurity, and client-protection risks. | Linked defense counsel conduct to prosecutorial convenience and MPD evidence-access goals. |
| September 2025 Supplemental #3.1 | DPA speech-waiver analysis | Added a standalone First Amendment theory: resolution terms allegedly required surrender or removal of protected speech. | Connected Tipp's advice and negotiation posture to prosecution leverage, E'Lise Chard/YWCA speech suppression concerns, and unconstitutional-condition arguments. |
| September-October 2025 response/reply cycle | Tipp response and complainant rebuttal | The dispute sharpened around whether the grievance was merely a civil-scope complaint or a criminal-defense malpractice complaint involving active discouragement, failure to investigate, and constitutional prejudice. | The response/reply cycle made witness credibility, characterization of the grievance, and the effect of delayed dismissal central issues. |
...
| July 30, 2026 closure letter | Final ODC closure letter analyzing the complainant's follow-up email | Added the technicality-defense analysis documenting that ODC collapsed discrete allegations into an outcome-based "strategy" label, asserted counsel "was able to provide explanation" without disclosing the record, and confirmed by verbatim direct review that ODC's own text states the complainant "did pursue" a Montana Supreme Court appeal — a claim consistent with the complainant's account, but one ODC has never followed with a disclosed status, docket number, or disposition for that appeal. | Turns the closure sequence into a documented evidentiary black box: rule-by-rule MRPC mapping, ABA Criminal Justice Standard 3-5.8, the family-forced conclusion chronology, and the undisclosed Supreme Court review status all remain on the record for review. |
...
| July 30, 2026 letter to Elvis Nuno | ODC letter, signed by Chief Disciplinary Counsel Pamela D. Bucy, responding to the forwarded Supplemental Submission #4 follow-up | Restated the "strategy vs. objectives" distinction, characterized the newly submitted exculpatory/mitigation material as "additional examples of strategy" not changing ODC's analysis, and asserted (without disclosing) that Tipp "was able to provide explanation." Its closing sentence — confirmed verbatim by direct image review, identical to the July 10 letter — states that ODC's records indicate the complainant "did pursue" a Montana Supreme Court appeal, without disclosing that appeal's status, docket number, or disposition. | Documented verbatim and analyzed in the technicality-defense article and the public-facing explainer; establishes the "evidentiary black box" pattern in ODC's closure practice, now including an unresolved question of whether a parallel Supreme Court review remains open. |
| August 21, 2026 letter to Eleanor Nuno | ODC letter responding to Eleanor Nuno's May 2026 independent grievance | Per a family legal-analysis memorandum's description and quotation (not independently supplied to the repository), ODC stated the grievance was placed into her son's existing file rather than opened separately, and that considering the information "did not change our analysis of this matter." Restates the November 3, 2025 dismissal and January 7, 2026 Commission affirmance. **No response has been received from ODC regarding the Tyrone Nuno supporting-witness grievance.** | Resolves the prior "no response received" status for Eleanor Nuno's submission (Tyrone's remains unanswered) and raises an unresolved question about how her independent-grievance standing was actually processed. |
...
| Representation-gap investigative report | "When 'Strategy' Ends the Inquiry: Investigative Review of ODC File No. 25-147 and the Documented Difficulty Securing Counsel" | Adds an exhibit-by-exhibit comparison of allegations against ODC's visible reasoning, a focused analysis of the "strategy" rationale in the July 10 and July 30, 2026 closure letters, and a February 6, 2026 attorney-outreach record documenting one Montana lawyer's declination and a perceived scarcity of Montana plaintiff-side legal-malpractice counsel. | Extends the case-specific record into a Montana representation-gap and access-to-justice analysis, published in the Research Reports, Legal Advocacy, and Analysis section. |
...
* [MT Bar Complaint ODC No. 25-147 - Bryan Tipp of Tipp, Colburn, Lockwood, P.C. (July 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july)
...
* [MT Bar Complaint ODC No. 25-147 - Bryan Tipp of Tipp, Colburn, Lockwood, P.C. (July 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july-2025)
  * **Summary:** Duplicate or alternate rendering of the same complaint text. Useful for cross-checking language and attachments.
  * **What changed at this stage:** No new allegations. It hardens the record set against format drift.

#### Supplemental Submission #1 (with appendices)

* [MT Bar Complaint ODC No. 25-147: Supplemental Submission #1 (August 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-1-august-2025)
  ...
  * [Appendix A: Comparison of Officer Smith vs. Detective Brueckner Conflicts](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-1-august-2025/appendix-a-comparison-of-officer-smith-vs.-detective-brueckner-conflicts)
    * **Summary:** Side-by-side conflict framing for two investigators. It supports “obvious red flags” and “failure to investigate” themes.
    * **What changed at this stage:** Adds a clean conflict comparison for quick citations.
  * [Appendix B: List of Motions That Should Have Been Filed](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-1-august-2025/appendix-b-list-of-motions-that-should-have-been-filed)
    * **Summary:** A checklist of motions the submission argues were mandatory or standard. It is an IAC-style map of omissions.
    * **What changed at this stage:** Converts broad claims of inaction into a concrete list.
  * [Appendix C: Constitutional Violations Identified But Not Addressed](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-1-august-2025/appendix-c-constitutional-violations-identified-but-not-addressed)
    * **Summary:** Enumerates constitutional issues the record claims were visible in real time. It links them to professional obligations.
    * **What changed at this stage:** Consolidates constitutional arguments into a single reference page.
  * [Appendix D: Documentation of Lost Civil Claims and Statute of Limitations](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-1-august-2025/appendix-d-documentation-of-lost-civil-claims-and-statute-of-limitations)
    * **Summary:** Ties alleged malpractice to specific time-barred claims and dollars. This is the damages and deadline spine.
    * **What changed at this stage:** Moves the SOL argument from abstract to itemized.

#### Supplemental Submission #3 (device-password coercion and speech waiver)

* [MT Bar Complaint ODC No. 25-147: Supplemental Submission #3 - Cover Letter (September, 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-3-cover-letter-september-2025)
  ...
  * [MT Bar Complaint ODC No. 25-147: Supplemental Submission #3 (September, 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-3-cover-letter-september-2025/mt-bar-complaint-odc-no.-25-147-supplemental-submission-3-september-2025)
    * **Summary:** Details the password demand and pressure campaign. Frames Fifth Amendment risk and cybersecurity harms.
    * **What changed at this stage:** Adds a discrete incident with specific conduct and risk analysis.
  * [MT Bar Complaint ODC No. 25-147: Supplemental Submission #3.1 (September, 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-bryan-tipp-of-tipp-colburn-lockwood-p.c.-july/mt-bar-complaint-odc-no.-25-147-supplemental-submission-3-cover-letter-september-2025/mt-bar-complaint-odc-no.-25-147-supplemental-submission-3.1-september-2025)
    * **Summary:** Argues an unconstitutional condition: speech removal as a case-resolution requirement. Frames it as categorical ethics failure.
    * **What changed at this stage:** Introduces a First Amendment waiver theory as a standalone discipline basis.

#### Respondent response and complainant reply

* [Bryan Tipp Re: ODC File No. 25-147 (September, 23 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-response-to-bryan-tipp-bar-complaint-answer-octo)
  ...
  * [MT Bar Complaint ODC No. 25-147: Response to Bryan Tipp Bar Complaint Answer (October 4th, 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-response-to-bryan-tipp-bar-complaint-answer-octo/mt-bar-complaint-odc-no.-25-147-response-to-bryan-tipp-bar-complaint-answer-october-4th-2025)
    * **Summary:** Rebuttal that rejects “scope” framing. Re-centers on active discouragement, deadline prejudice, and constitutional harm.
    * **What changed at this stage:** The complainant sharpens the issue into “mischaracterization plus consequences.”

#### ODC disposition and review materials

* [MT Bar Complaint ODC No. 25-147: ODC Ruling (November 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-no.-25-147-response-to-bryan-tipp-bar-complaint-answer-octo/mt-bar-complaint-odc-no.-25-147-odc-ruling-november-2025)
...
* [MT Bar Complaint ODC-25-147 - Right To Request Review (November 2025)](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-25-147-right-to-request-review-november-2025)
  ...
  * [RE: GRIEVANCE AGAINST BRYAN C. TIPP REQUEST FOR REVIEW](https://www.ywcaofmissoula.com/montana-bar-complaints/mt-bar-complaint-odc-25-147-right-to-request-review-november-2025/re-grievance-against-bryan-c.-tipp-request-for-review)
...
#### Companion Lowney prosecutorial-misconduct grievance
...
* [ODC Lowney Grievance (April 2026) — Montana Bar Complaint Index](https://www.ywcaofmissoula.com/montana-bar-complaints/odc-lowney-grievance-index)
  * **Summary:** Companion index for the ODC grievance against Brian Lowney and the Missoula County Attorney's Office.
  * **What changed at this stage:** Links the defense-counsel malpractice record to the prosecutorial-misconduct record so readers can evaluate Tipp's alleged omissions against the State's alleged Brady/Giglio, protected-speech, charging, bail, and DPA-leverage conduct.
* [Grievance to Montana ODC — Brian Lowney (April 28, 2026)](https://www.ywcaofmissoula.com/montana-bar-complaints/grievance-to-montana-odc-brian-lowney-4.28.2026)
  * **Summary:** Formal grievance alleging prosecutorial misconduct, Brady violations, abuse of process, reliance on tainted MPD investigative work, and unconstitutional speech waiver in Cause No. DC-18-587.
  * **What changed at this stage:** Opens the prosecution-side accountability track that is intertwined with the Tipp complaint: the same alleged Smith removal, Brueckner/YWCA conflict, E'Lise Chard evidence, protected-speech ruling, and DPA speech restriction are relevant both to Lowney's duties as prosecutor and Tipp's duties as defense counsel.
...
* [The ODC's Technicality Defense — Analysis of the July 30, 2026 Closure Letter in ODC File No. 25-147](https://www.ywcaofmissoula.com/montana-bar-complaints/odc-file-no-25-147-july-30-2026-closure-letter-technicality-defense-analysis) — now includes the DPA speech-waiver, gag-order, appeal-barrier, and family-demand chronology analysis
  * **Summary:** Analyzes the July 30, 2026 closure letter as a strategy-versus-duty response that narrows the complaint to an outcome-based technicality defense and omits individualized analysis of the conflict, witness, evidence, diligence, and family-pressure allegations. The surrounding record states that the matter ended only when Tyrone and Eleanor Nuno directly demanded resolution, which further undercuts the claim that this was simply counsel's chosen strategy. The article maps each omitted allegation to its MRPC implication, applies ABA Criminal Justice Standard 3-5.8 to the speech-waiver issue, and documents two procedural defects: ODC asserts counsel "was able to provide explanation" without identifying any document or note that contains it, and it cites a Supreme Court appeal path that is practically inaccessible because no in-state attorney will take the matter.
  * **What changed at this stage:** Adds the later July 30 closure letter as a distinct agency response and makes it easy to compare against the July 10 letter, Supplemental Submission #4, and the supporting-witness grievances documenting the forced-conclusion chronology. It also establishes the evidentiary black-box pattern (closure justified by an undisclosed record) that connects ODC's closure practice to the broader institutional opacity analysis.
...
* [Tyrone Nuno Supporting Witness Grievance — ODC File No. 25-147 (May 2026)](https://www.ywcaofmissoula.com/montana-bar-complaints/tyrone-nuno-supporting-witness-grievance-odc-25-147-may-2026)
...
* [Eleanor ("Ellie") Nuno Independent ODC Grievance — ODC File No. 25-147 (May 2026)](https://www.ywcaofmissoula.com/montana-bar-complaints/eleanor-ellie-nuno-independent-odc-grievance-odc-25-147-may-2026)
  ...
  * **ODC response:** ODC responded by letter dated August 21, 2026, stating the grievance was placed into her son's existing file rather than opened as a separate grievance and that it did not change ODC's analysis. See the [public-facing explainer article](public-article-odc-25-147-what-the-ruling-means-and-why-it-warrants-review.md) for the full text and attribution (known to this repository only via a family legal-analysis memorandum's description and quotation, not an independently supplied original).
