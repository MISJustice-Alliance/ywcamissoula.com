...
description: >-
  Source-grounded analysis of ODC's July 10, 2026 response to Supplemental
  Submission #4, including the two evidence-investigation allegations, the
  governing Montana disciplinary rules, and limits on further review.
---
...
![ODC response letter dated July 10, 2026](../.gitbook/assets/odc-25-147-response-july-10-2026.jpg)
...
The intended reading of that sentence is unresolved on the public record, and this page previously asserted a "confirmed by Nuno" reading that has since been corrected. Direct image review of both the July 10, 2026 and July 30, 2026 letters (conducted 2026-09-24) shows the sentence prints identically in both, with no "not": **"our records indicate that you did pursue such an appeal."** Per the complainant's own account, that reading is accurate — he did submit a request for Montana Supreme Court review of ODC's disposition. What remains unresolved is not the wording, but ODC's silence on that appeal's status: neither letter, nor any other document currently in the record, discloses a docket number, a pending/decided status, or a disposition for that review. That leaves open whether ODC File No. 25-147 is, in some procedural sense, still under review at the Montana Supreme Court level notwithstanding ODC's own "this matter remains closed" language — a state with no public reconciliation, tracked on the [case index](odc-25-147-bryan-tipp-montana-bar-complaint-index.md#unresolved-procedural-status--the-supreme-court-review-question) as an open question pending independent verification against the Montana Supreme Court's own docket.
