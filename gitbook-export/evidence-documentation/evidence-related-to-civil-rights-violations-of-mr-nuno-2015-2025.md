...
### I. What this evidence set covers
...
### II. Primary evidence types (high-signal categories)

#### A. Location, timing, and “objective” data

These records are useful because they do not rely on anyone’s memory.
...
### III. Fourth Amendment evidence (entry, seizure, and digital search)

#### A. 2015 Edmonds SWAT / excessive-force posture

**Evidence**: police reports, witness statements, and medical records.

**Why it matters**: supports unreasonable seizure and related due process claims.
...
* Monitoring/GPS data consistent with compliance.
* Court records showing missing legal basis for the arrest.
* Detention documentation showing extended confinement and process failures.
...
* Warrant language requesting essentially **all account data**.
* Returns/results showing **no mention of E’Lise Chard**.
* Defense motion practice acknowledging the scope/particularity problem.

***

### IV. Fabricated evidence and false reporting

#### A. E’Lise Chard reports and narrative inflation

Common patterns visible in the record:

* Claims of criminal/drug history that do not match the underlying history.
* “Threat” framing that does not match the actual communication content.
* Alleged ongoing proximity contradicted by location/monitoring data.

#### B. Danielle Chard narrative construction

Key contradictions repeatedly show up as:

* “One date” framing versus a long documented relationship history.
* Cross-country stalking framing versus periods of direct communication.
* Allegations about social posts that do not match archived content.

#### C. Mental health and reliability issues (handled as an evidentiary question)

If you intend to use psychological dynamics, keep it tight:

* Focus on **observable behaviors** and objective contradictions.
* Use experts for any diagnostic claims.
* Avoid overstating beyond what the record supports.

***

### V. First Amendment retaliation evidence (protected speech → escalation)

#### A. Protected activity records
...
### VI. Legal malpractice evidence (Bryan Tipp)

This section focuses on records showing knowledge, advice, and resulting statute exposure.

#### A. “Give the matter time” + statute risk

* Client communications requesting civil rights advocacy (2017–2021).
* Written advice to delay action.
* Records showing counsel understood constitutional issues while discouraging action.

#### B. “Not viable / too speculative” despite continuing harms

* Ongoing harassment submissions (2020–2022).
...
#### C. High-level malpractice damages snapshot (illustrative)
...
### VII. Prosecutorial misconduct evidence

#### A. Brady / suppression themes

Common suppressed or minimized items include:

* Compliance and monitoring data.
* Weak/absent results from broad digital searches.
* Conflict indicators and credibility problems within complainant narratives.

#### B. Malicious prosecution checklist (mapped to evidence)

1. **Charges filed**.
2. **Lack of probable cause** (or evidence inconsistent with PC).
3. **Favorable termination** (dismissal with prejudice).
4. **Improper motive** (retaliation and coordinated pressure).
5. **Damages** (see damages section).

***

### VIII. YWCA institutional liability evidence

#### A. Knowledge and ratification

* Receipt of complaint materials and internal notice.
...
#### B. State-action / quasi-governmental function support

This evidence tends to cluster around:

* Government funding and contractual relationships.
* Formal liaison roles with police.
* Coordination patterns consistent with joint action.

***

### IX. Damages evidence (quantified)

#### A. Quantified economic loss: **$3,441,000**

| Category        |     Amount | Typical supporting records            |
| --------------- | ---------: | ------------------------------------- |
| Lost IT career  | $2,100,000 | contracts, tax/earnings, market comps |
| Contract losses |   $680,000 | termination letters, client comms     |
| Legal fees      |   $387,000 | invoices, payment records             |
| Medical costs   |   $148,000 | treatment records, evaluations        |
| Family medical  |    $76,000 | records and causation narrative       |
| Other costs     |    $50,000 | monitoring, bail, investigation       |

#### B. Reputation and employability harm

* Background check artifacts.
* Client “safety concern” communications.
* Lost opportunities linked to dismissed-but-visible charges.

***

### X. Ongoing harassment evidence (2019–2025+)
...
### XI. RICO predicate framing (evidence-first)

Keep this section evidence-driven. Avoid conclusions that require a court finding.
