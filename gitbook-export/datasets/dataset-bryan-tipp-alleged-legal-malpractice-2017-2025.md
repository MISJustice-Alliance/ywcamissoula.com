...
* Malpractice analysis: [Bryan Tipp malpractice (2017–2025)](https://www.ywcaofmissoula.com/montana-legal-cases/2017-2025-bryan-tipps-malpractice-its-devastating-impact-on-civil-rights-account)
...
* `date`
* `matter` (criminal defense, post-conviction, civil rights)
* `allegation_type` (missed deadline, failure to investigate, conflict handling, client communication)
* `source_type` (ODC filing, email, motion, order)
* `source_url`
* `summary`
