...
The Montana Commissioner of Political Practices publishes the official decision PDF and companion settlement PDF for the Fletcher matter titled "Fletcher v. Montanans for Veracity, Diversity and Work." In this pass, I transcribed both documents below so the report now carries the source record directly instead of only pointing to archive indexes. (Source: COPP decision PDF; COPP settlement PDF)
