...
This page is a jump index for evidence themes involving alleged **prosecutorial misconduct**, **Brady / Giglio disclosure** issues, and the companion **Lowney ODC grievance / abuse-of-process** track in the Nuno record.

Use it to move from theme → documents → packet-ready citations, then validate each point against the linked primary artifacts and grievance materials.
...
#### What counts as a “Brady issue” in this record?

Material exculpatory or impeachment information that was allegedly withheld, minimized, or not surfaced.

This index treats conflicts, credibility issues, and suppressed context as Brady-adjacent themes to verify.

#### Where do I start if I want a short checklist?

Start with the mapped checklist on the prosecutorial misconduct evidence page.

Then follow the linked packets and rulings.

#### Where are the prosecutor-facing outreach packets?

They are collected under the published case file indexes.

Start with [CR-2025-001 — Case files index](https://www.ywcaofmissoula.com/additional-evidence-and-documentation/missoula-1983-misconduct-mpd-prosecutors-ywca-of-missoula-expanded-history/evidence-related-to-civil-rights-violations-of-mr-nuno-2015-2025/cr-2025-001-case-files-index).

#### How does this connect to §1983?

Brady and malicious prosecution themes are used here to support federal civil-rights theories.
...
#### Where are the underlying primary records?
